...
class Doll{
    ...
    async start(){
            ...
            this.lookForward()
            await delay((Math.random()  * 700) + 750)
            this.start()
    }
}
...
function createtrack(){
    ...
    createCube({w: start_position *2 + .2, h: 1.5, f: 1.5}, 0, .0, 0xe5a716).position.z = -1;
    createCube({w: .2, h: 1.5, f: 1.5}, start_position, -.35);
    createCube({w: .2, h: 1.5, f: 1.5}, end_position, .35);
